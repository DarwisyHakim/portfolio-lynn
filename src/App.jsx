...
const img = (filename) => `${import.meta.env.BASE_URL}works/${filename}`;
...
image: img("mushroom-character.jpg"),
},
{
...
return ( <section id={id} className="section"> <div className="section-heading"> <p className="eyebrow">{eyebrow}</p> <h2>{title}</h2> </div>
...
return ( <div className="site"> <header className="hero">
